      ...
      describe :oclc_numbers_from do
        ...
        context 'failure' do
          it 'rejects an Excel 95 (.xls) workbook' do
            xls_path = 'spec/data/excel/oclc-numbers-excel95.xls'
          ...
          it 'rejects an Excel 97 (.xls) workbook' do
            xls_path = 'spec/data/excel/oclc-numbers-excel97.xls'
          ...
          it 'rejects an Excel 95 workbook renamed to .xlsx' do
            xls_path = 'spec/data/excel/oclc-numbers-excel95-as-xlsx.xslx'
